...
{
    public class WBIRecycler : PartModule
    {
        ...
        [KSPField(guiName = "Recycler", isPersistant = true, guiActiveEditor = true, guiActive = true)]
        [UI_Toggle(enabledText = "On", disabledText = "Off")]
        public bool recyclerToggle;
        ...
        public override void OnUpdate()
        {
            ...
            if (animationModule != null)
            {
                if (animationModule.aniState != ModuleAnimateGeneric.animationStates.LOCKED)
                    return;
